...
public abstract class Conta {	
	...
	protected ArrayList<Transaccao> listaTransaccao = new ArrayList<Transaccao>();
	...
	public void depositar(double valor){
		saldo += valor;
		Deposito d = new Deposito(new Date(), this, valor);
		listaTransaccao.add(d);
	}
	...
	public void mostrarExtracto(){
		for(int i = 0; i < listaTransaccao.size(); i++){
			Transaccao corrente = listaTransaccao.get(i);
			System.out.println(corrente.mostrar());
		}
